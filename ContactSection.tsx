      ...
      <div className="max-w-5xl mx-auto text-center">
        <div className="mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            I'm looking for the 1-2 insane builders who want to change the way humans connect for the better.
          </p>
        </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Email with "COFOUNDER" in subject line. Include your most impressive achievement & a link to your past projects
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Quick conversation to see if we connect and share a vision
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Build prototypes, hack, and create something cool together in NYC
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-primary/20 to-accent/20 rounded-2xl p-8">
          ...
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            We have real traction, value-add investors, and a proven market. Now we need the right technical team to take us to the next level.
          </p>
          <Button 
            size="lg"
